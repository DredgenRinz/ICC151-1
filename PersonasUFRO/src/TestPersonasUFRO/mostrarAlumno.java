 ...
 * @author yojvn
 */
public class mostrarAlumno extends javax.swing.JFrame {

    private static Alumno yolo = null;
    /**
    ...
    public mostrarAlumno(){
        ...
        nombre.setText(yolo.getNombre());
        apellido.setText(yolo.getApellido()); 
        rut.setText(Integer.toString(yolo.getRut()));
        direc.setText(yolo.getDireccion());
        cumple.setText(yolo.getCumpleaños());
        carrera.setText(yolo.getCarrera()); 
        descrip.setText(yolo.getDescripcion()); 
        telefono.setText(Integer.toString(yolo.getTelefono()));
        codcarr.setText(Integer.toString(yolo.getCodigo()));
        añoIngreso.setText(Integer.toString(yolo.getAñoIngreso()));

        initComponents();
        
    }
    
    public static void SetAlumno(Alumno temp){
    yolo = temp;
    }
